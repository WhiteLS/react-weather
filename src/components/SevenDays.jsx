      ...
      {days.map((item) => {
        ...
        return (
          <div className="day" key={item.dt}>
            <div className="main__sevenDay__box">
              <div className="button button--radius button--desc">
                <p>
                  {weekday[date.getDay()]}, {date.getDate()} {month[date.getMonth()]}
                </p>
              </div>
              <ul>
                <li>Ощущается как, &deg;С</li>
            ...
            <div className="card card--seven card--table">
              <table>
                <tbody>
                  <tr>
                    <td className="table__cell__temp">
                      <p>Утром</p>+{Math.round(item.temp.morn)}&deg;
                    </td>
                    <td className="table__cell__cloudy">
                      <svg
                    ...
                    <td>+{Math.round(item.feels_like.morn)}&deg;</td>
                    <td>{item.pop}%</td>
                  ...
                  <tr>
                    <td className="table__cell__temp">
                      <p>Днём</p>+{Math.round(item.temp.day)}&deg;
                    </td>
                    <td className="table__cell__cloudy">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <td>+{Math.round(item.feels_like.day)}&deg;</td>
                    <td>{item.pop}%</td>
                    <td>{Math.round((item.pressure * 3) / 4)}</td>
                    <td>{item.wind_speed}</td>
                    <td>{item.humidity}%</td>
                  ...
                  <tr>
                    <td className="table__cell__temp">
                      <p>Вечером</p>+{Math.round(item.temp.eve)}&deg;
                    </td>
                    <td className="table__cell__cloudy">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <td>+{Math.round(item.feels_like.eve)}&deg;</td>
                    <td>{item.pop}%</td>
                    <td>{Math.round((item.pressure * 3) / 4)}</td>
                    <td>{item.wind_speed}</td>
                    <td>{item.humidity}%</td>
                  ...
                  <tr>
                    <td className="table__cell__temp">
                      <p>Ночью</p>+{Math.round(item.temp.night)}&deg;
                    </td>
                    <td className="table__cell__cloudy">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                    ...
                    <td>+{Math.round(item.feels_like.night)}&deg;</td>
                    <td>{item.pop}%</td>
                    <td>{Math.round((item.pressure * 3) / 4)}</td>
                    <td>{item.wind_speed}</td>
                    <td>{item.humidity}%</td>
